function sidebar_button_highlight() {
    ...
    if (window.location.href === "https://geonerd-linggeek.github.io/games/") {
    ...
    if (window.location.href === "https://geonerd-linggeek.github.io/bots/") {
    ...
    if (window.location.href === "https://geonerd-linggeek.github.io/about/") {
    ...
    if (window.location.href === "https://geonerd-linggeek.github.io/channels/") {
    ...
    if (window.location.href === "https://geonerd-linggeek.github.io/languages/") {
